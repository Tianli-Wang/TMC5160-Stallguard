...
//IHOLD 静止状态下电机电流(0=1/32...31=32/32)在 stealthChop 模式下，设置 IHOLD=O可配置电机静止状态为飞轮模式或线圈短路模式。
//IRUN  电机运行电流(0=1/32...31=32/32)提示:选择适合的采样电阻，建议 IRUN 设置范围是 16到 31，以获得最佳的微步性能。
#define TMC5160_IHOLD_IRUN     0x10

//TPOWERDOWN设置电机静止后 (stst)到电机开始降电流的之间的延时时间。时间范围约为 0至4 秒注意:要决最小设置为2，以允许自动校准stealthChop
#define TMC5160_TPOWERDOWN     0x11

//n=20 当使用运动控制器时，对于给定速度 V，测量的 TSTEP 在(2^24/V)≤TSTEP<2^24/V-1范围内
